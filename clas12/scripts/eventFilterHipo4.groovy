...
List<String> dataFiles = FileFinder.getFiles("/w/hallb-scifs17exp/clas12/rg-a/production/recon/pass0/v5/mon/005032/*");
...
for(String dataFile : dataFiles){
    ...
    writer.open("/w/hallb-scifs17exp/clas12/viducic/data/clas12/run_005032_filtered.hipo");
